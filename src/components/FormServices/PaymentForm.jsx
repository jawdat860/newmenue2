...
//  return(
//     <section className="bg-white py-8 antialiased dark:bg-gray-900 md:py-16 h-[100vh]">
//   <div className="mx-auto max-w-screen-xl px-4 2xl:px-0 h-full">
//     <div className="mx-auto max-w-5xl h-full ">
//       <h2 className="text-xl font-semibold text-gray-900 dark:text-white sm:text-2xl">Платеж</h2>

//       <div className="mt-6 sm:mt-8 lg:flex lg:items-start lg:gap-12 h-full">
//         <form action="#" className="w-full h-full  rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 sm:p-6 lg:max-w-xl lg:p-8">
//           <div className="mb-6 grid items-end grid-cols-2 gap-4">
//             <div className="col-span-2 sm:col-span-1">
//               <label htmlFor="full_name" className="mb-2 block text-sm font-medium text-gray-900 dark:text-white"> Полное имя (как указано на карточке)* </label>
...
//             <div className="col-span-2 sm:col-span-1">
//               <label htmlFor="card-number-input" className="mb-2 block text-sm font-medium text-gray-900 dark:text-white"> Номер карты* </label>
...
//             <div>
//               <label htmlFor="card-expiration-input" className="mb-2 block text-sm font-medium text-gray-900 dark:text-white"> окончания действия карты* </label>
...
//                     <path fillRule="evenodd" d="M2 12C2 6.477 6.477 2 12 2s10 4.477 10 10-4.477 10-10 10S2 17.523 2 12Zm9.408-5.5a1 1 0 1 0 0 2h.01a1 1 0 1 0 0-2h-.01ZM10 10a1 1 0 1 0 0 2h1v3h-1a1 1 0 1 0 0 2h4a1 1 0 1 0 0-2h-1v-4a1 1 0 0 0-1-1h-2Z" clip-rule="evenodd" />
//                   </svg>
//                 </button>
...
//                 Последние 3 цифры на обратной стороне карточки
...
//           <button type="submit" className="flex w-full items-center bg-black justify-center rounded-lg bg-primary-700 px-5 py-2.5 text-sm font-medium text-white hover:bg-primary-800 focus:outline-none focus:ring-4  focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Сохранить </button>
//         </form>
