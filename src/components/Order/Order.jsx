...
function Order() {
  ...
  return (
    <div
      id="genn-Order-all"
      className="h-screen bg-[white] dark:bg-gray-900 rounded-lg shadow-lg flex flex-col justify-between"
    >
      <div
        id="genn-Order-Cards"
        className="bg-[#eee]  dark:bg-gray-800 p-8 rounded-lg shadow-md"
      >
      ...
      <div
        ...
        className="mt-8 jawdat2 bg-[#eee] dark:bg-gray-800 rounded-lg shadow-md p-8 grid gap-6 flex-1"
      >
        <h2 className="text-2xl font-semibold text-gray-800 dark:text-white mb-4">
          {LocalText.orderPage.formTitle}
        </h2>
